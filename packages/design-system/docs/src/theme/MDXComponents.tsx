...
const StorybookEmbed = ({ id }: StorybookEmbedProps) => {
  ...
  return (
    <>
      <a
        href={`${baseStorybook}/?path=/story/${id.split("--")[0]}`}
        className="button button--primary margin-bottom--md button--md"
        target="_blank"
      ...
      >
        ...
        >
          ...
          <g>
            ...
            <use fill="currentColor" fill-rule="nonzero" href="#path-1"></use>
            <path
      ...
      <iframe
        src={`${baseStorybook}/iframe.html?id=${id}&viewMode=story&shortcuts=false&singleStory=true`}
        width="100%"
        height="500px"
      />
    </>
