 ...
 * Provides utility methods for working with bibliographic citations and references.
 */
export class FhirCitation extends FhirDomainResource<Citation> {
  // Static Functions

  /**
   * Parses a Citation resource from unknown data.
   *
   * @param value - The data to parse and validate against the Citation schema
