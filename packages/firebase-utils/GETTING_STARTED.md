...
# Getting Started with firebase-utils

This guide will help you get started with using the firebase-utils package in your project.
...
```typescript
import { SchemaConverter } from 'firebase-utils'
import { z } from 'zod'
...
```typescript
import { LocalizedText } from 'firebase-utils'
...
```typescript
import { advanceDateByDays, advanceDateByHours } from 'firebase-utils'
...
```typescript
import { average, median, chunks, compactMap } from 'firebase-utils'
